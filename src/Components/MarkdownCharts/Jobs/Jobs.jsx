...
const LOCATION_COLORS = {
  region: "#5C9DED", // lighter blue
  hw: "#60AD5E", // lighter green
  pe: "#FB8C00", // softer orange
  co: "#9C4DCC", // lighter purple
  che: "#E57373", // lighter red
  din: "#26C6DA", // lighter cyan / teal
  pg: "#FDD835", // softer yellow
};

const INITIAL_VISIBLE_LOCATIONS = ["region", "hw", "pe", "co"];
...
const MortgageChart1 = ({ dataPath, config }) => {
  ...
  const [selectedMode, setSelectedMode] = useState(
    config?.transportModes?.options?.[0]?.value || "total"
  );
